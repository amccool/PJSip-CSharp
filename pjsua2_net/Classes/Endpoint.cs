...
public class Endpoint : global::System.IDisposable {
  ...
  public SWIGTYPE_p_void videoCodecGetParam(string codec_id) {
    global::System.IntPtr cPtr = pjsua2PINVOKE.Endpoint_videoCodecGetParam(swigCPtr, codec_id);
    SWIGTYPE_p_void ret = (cPtr == global::System.IntPtr.Zero) ? null : new SWIGTYPE_p_void(cPtr, false);
    if (pjsua2PINVOKE.SWIGPendingException.Pending) throw pjsua2PINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public void videoCodecSetParam(string codec_id, SWIGTYPE_p_void param) {
    pjsua2PINVOKE.Endpoint_videoCodecSetParam(swigCPtr, codec_id, SWIGTYPE_p_void.getCPtr(param));
    if (pjsua2PINVOKE.SWIGPendingException.Pending) throw pjsua2PINVOKE.SWIGPendingException.Retrieve();
  }
